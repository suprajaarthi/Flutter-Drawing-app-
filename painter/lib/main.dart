...
class _ExamplePageState extends State<ExamplePage> {
  ...
  PainterController _newController() {
    ...
    controller.backgroundColor = Colors.cyan[50];
    return controller;
  }
  ...
  Widget build(BuildContext context) {
    ...
    if (_finished) {
      actions = <Widget>[
        new IconButton(
          icon: new Icon(Icons.fiber_new_outlined),
    ...
    return new Scaffold(
      appBar: new AppBar(
          title: const Text('Pen your ideas!!!'),
          backgroundColor: Colors.orangeAccent,
          // actions: <Widget>[
          //   new FlatButton(child: new Text("OK"), onPressed: null)
          // ],
      ...
      body: new Center(
          child: new AspectRatio(
              aspectRatio: 0.6, child: new Painter(_controller))),
    );
  }
      ...
      children: <Widget>[
        ...
        new StatefulBuilder(
          ...
          return new RotatedBox(
            quarterTurns: _controller.eraseMode ? 5 : 0,
            child: IconButton(
                icon: new Icon(
                  ...
                  size: 33.0,
                  color: _controller.eraseMode ? Colors.black : Colors.white,
                ),
                onPressed: () {
                  setState(() {
